          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
              <?php
                ...
                /*for($i; $i<50; $i++){ ESTO ES PARA CARGAR REGISTROS EN LA BASE DE DATOS, SOLO LO USO UNA VEZ
                  $resultado = $conexion->query("INSERT INTO productos (nombre, descripcion, precio, imagen, inventario, id_categoria, talla, color)
                  VALUES(
